...
<template>
  <q-page>
    <div class="row justify-center column align-center full-width" style="align-items: center;">
      <q-input
        v-model="busqueda"
        bg-color="white"
        square
        ...
        outlined
        :debounce="600"
        placeholder="Buscar por caratula del caso"
        class="input-clase"
      />
      <div style="margin-top: 20px">
        <q-radio v-model="orden" val="ESPERADA" label="Ordenar por Proxima Fecha de Audiencia" />
        <q-radio v-model="orden" val="ALTA" label="Ordenar por Fecha de Alta" />
      </div>
    </div>
