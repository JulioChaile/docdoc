  ...
  <div>
    ...
    >
      <div class="row text-center">
        ...
        <span v-if="Ver.Actores" class="col self-center">Actores</span>
        <span v-if="Ver.Demandados" class="col self-center">Demandados</span>
      </div>
    </q-banner>
        ...
        >
          ...
          >
            ...
            <div
              ...
              v-if="Ver.FechaHecho"
            >
              <q-tooltip anchor="bottom middle" self="top middle" :offset="[10, 0]">Fecha del Hecho</q-tooltip>
              {{ m.FechaHecho || 'Sin datos' }}
            </div>
            <div
              class="col self-center text-center"
              v-if="Ver.Doc"
            ...
            <div
              class="col self-center text-left text-caption"
              v-if="Ver.Actores"
            >
              <q-tooltip anchor="bottom middle" self="top middle" :offset="[10, 0]">Actores</q-tooltip>
              <ul style="margin: 0; padding: 0; padding-left: 15px">
                <li
                  v-for="h in m.Actores"
                  :key="h"
                >
                  {{ h }}
                </li>
            ...
            <div
              ...
              v-if="Ver.Demandados"
            >
              <q-tooltip anchor="bottom middle" self="top middle" :offset="[10, 0]">Demandados</q-tooltip>
              <ul style="margin: 0; padding: 0; padding-left: 15px">
                <li
                  v-for="h in m.Demandados"
                  :key="h"
                >
                  {{ h }}
                </li>
  ...
  computed: {
    Ver () {
      return {
        ...
        Nominacion: this.Grilla.includes('Nominacion'),
        Juzgado: this.Grilla.includes('Juzgado'),
        ...
        Actores: this.Grilla.includes('Actores'),
        Demandados: this.Grilla.includes('Demandados'),
        FechaHecho: this.Grilla.includes('FechaHecho')
      }
    }
  },
  methods: {
