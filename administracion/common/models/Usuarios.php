...
class Usuarios extends Model implements IdentityInterface
{
    ...
    {
        $sql = 'CALL dsp_dame_usuario( :idUsuario )';
     ...
     * dsp_dame_usuario_por_usuario
     */
    public function DamePorUsuario()
    {
        $sql = 'CALL dsp_dame_usuario_por_usuario( :usuario )';
     ...
     * dsp_dame_usuario_por_email
     */
    public function DamePorEmail()
    {
     ...
     * dsp_dame_usuario_por_telefono
     */
    public function DamePorTelefono()
    {
        $sql = 'CALL dsp_dame_usuario_por_telefono( :telefono )';
     ...
     * error en Mensaje. dsp_activar_usuario
     */
    public function Activar()
    {
        $sql = "CALL dsp_activar_usuario ( :token, :id, :IP, :userAgent, :app )";
     ...
     * error en Mensaje. dsp_darbaja_usuario
     */
    public function DarBaja()
    {
        $sql = "CALL dsp_darbaja_usuario ( :token, :id, :IP, :userAgent, :app )";
     ...
     * sesi�n. dsp_dame_usuario_por_token
     */
    public function DamePorToken()
    {
        $sql = 'CALL dsp_dame_usuario_por_token( :token )';
     ...
     * dsp_dame_password_hash
     */
    public function DamePassword()
    {
        $sql = "CALL dsp_dame_password_hash ( :usuario )";
...
//            }
        ...
        $sql = "CALL dsp_cambiar_password( :modo, :token, :passwordNuevo, :IP, :userAgent, :aplicacion)";
     ...
     * dsp_dame_permisos_usuario
     */
    public function DamePermisos()
    {
        $sql = 'CALL dsp_dame_permisos_usuario ( :token )';
    ...
    public function ValidarCodigo($Codigo = null)
    {
        ...
        $sql = 'CALL dsp_validar_codigo( :usuario, :esValido,'
                . ' :IP, :userAgent, :app )';
    ...
    public function Login($App = '', $Pass = null, $Token = null)
    {
        ...
        */
        ...
        $sql = "CALL dsp_login( :usuario, :esValido, :token, :IP, :userAgent, :app )";
    ...
    {
        $sql = 'CALL dsp_existe_usuario( :usuario )';
     ...
     * dsp_usuario_estudio_listar_casos_compartidos
     */
    public function ListarCasosCompartidos()
    {
        $sql = 'CALL dsp_usuario_estudio_listar_casos_compartidos( :idusuario )';
    ...
    public function SetTokenApp()
    {
        $sql = 'CALL dsp_alta_usuario_token_app( :token, :idUsuario, :idEstudio, :tokenApp )';
    ...
    public function SetTokenAppCliente()
    {
        $sql = 'CALL dsp_alta_usuario_token_app_cliente( :token, :idUsuario, :usuario, :tokenApp )';
