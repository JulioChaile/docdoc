...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <?php else: ?>
                <h4 class="modal-title">Agregar cadete</h4>
            <?php endif; ?>
        </div>
        ...
        <div class="modal-body">
            ...
            <?= $form->field($model, 'TelefonoUsuario')->textInput(['autocomplete' => 'off']) ?>

            <?php if (!empty($cadete)): ?>
                <?= Html::activeHiddenInput($model, 'IdRolEstudio') ?>            
                <?= Html::activeHiddenInput($model, 'Observaciones') ?>            
