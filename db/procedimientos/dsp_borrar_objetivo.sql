DROP PROCEDURE IF EXISTS `dsp_borrar_objetivo`;
DELIMITER $$
CREATE PROCEDURE `dsp_borrar_objetivo`(pJWT varchar(500), pIdObjetivo int, 
				pIP varchar(40), pUserAgent varchar(255), pApp varchar(50))
PROC: BEGIN
	/*
    Permite borrar un objetivo y las asociaciones con los movimientos que tenga. Devuelve OK o un mensaje de error en Mensaje. 
    */
    ...
    START TRANSACTION;
        ...
        DELETE FROM MovimientosObjetivo WHERE IdObjetivo = pIdObjetivo;
        
        DELETE FROM Objetivos WHERE IdObjetivo = pIdObjetivo;
